...
function dy = bang_personal_protection(params, adata)
    ...
    while(test < 0)
        ...
        P = zeros(1,N+1);
        for i = 1:N+1
            P(i) = C1+(pS(i)-pI(i))*beta*I(i)*S(i);
            if P(i) > 0; U(i) = -1; else; U(i) = 1; end
        end
